        ...
        <div>
            <div id="tech" className="technologies container">
                ...
                <div className="tech center">
                    ...
                    <div className="icons col s6 m3">
                        <img src={MongoDb} style={{ height: "4.5rem" }} alt="image of mysql-workbench" srcset="" />
                        <p style={{ fontSize: "1rem", color: "#555555" }}>MongoDb</p>
                    </div>
                    <div className="icons col s6 m3">
                        <img src={MySql} style={{ height: '4.5rem' }} alt="image of mysql-workbench"
                            srcset="" />
